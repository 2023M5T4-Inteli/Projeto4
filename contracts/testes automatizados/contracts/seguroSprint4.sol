...
contract Seguro2 {
    ...
    mapping(address => bool) public memberIsActive;
...
assim como a taxa administrativa*/
    ...
    function getInfo() public view returns (address, uint256, uint){
        return (address(owner), adminTax, lmiTax);
    }
    function getMemberIsActive(address _address) public view returns (bool){
        return memberIsActive[_address];
    }
    function getMemberImei(address _address) public view returns(string memory){
        return memberImei[_address];
    }
}
